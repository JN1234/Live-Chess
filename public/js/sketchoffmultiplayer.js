...
let startFEN = "r3kbnr/2p1pp1p/p1nq2p1/1p1p1b2/P3P3/RPN2Q2/1BPP1PPP/4KBNR w q - 4 7";
    ...
    item.split("").forEach((value, index) => {
      ...
      if (whiteFEN.includes(value)) {
        ...
        if(value === "P" && y !== 6){
          ...
          if(FEN[2].includes("K") || FEN[2].includes("Q")){
          ...
          if(FEN[2].includes("Q") && index === 0){
            
            moved = false
            }
          else if(index !==0 && FEN[2].includes("K") && index === (item.length - 1)){
